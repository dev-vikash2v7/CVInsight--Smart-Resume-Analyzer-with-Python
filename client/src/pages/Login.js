          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                } placeholder-gray-400 text-white bg-gray-800 rounded-t-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm`}
            ...
            <div className="relative">
              ...
              <input
                ...
                } placeholder-gray-400 text-white bg-gray-800 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm`}
